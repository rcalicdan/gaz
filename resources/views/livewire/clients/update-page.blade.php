        ...
        <form wire:submit.prevent="update" class="p-6 space-y-8">
            ...
            <div class="space-y-6">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <x-forms.field label="{{ __('Contract Signed Date') }}" name="contract_signed_date">
                        <x-forms.input type="date" name="contract_signed_date"
            ...
            <div class="space-y-6">
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                    <x-forms.field class="md:col-span-2" label="{{ __('Street Name') }}"
                        name="registered_street_name" required>
            ...
            <div class="space-y-6">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <x-forms.field label="{{ __('Pickup Frequency') }}" name="pickup_frequency" required>
                        <x-forms.select name="pickup_frequency" wire:model.live="pickup_frequency"
                            :options="\App\Enums\PickupFrequency::options()" required />
                    ...
                    @if ($pickup_frequency === 'custom')
                        <x-forms.field label="{{ __('Custom Pickup Days') }}" name="custom_pickup_days" required
                            ...
                            <x-forms.input type="number" name="custom_pickup_days"
                                wire:model="custom_pickup_days"
            ...
            <div class="flex items-center justify-end space-x-4 pt-6 border-t border-gray-200">
                ...
                <x-utils.submit-button wire-target="update" buttonText="{{ __('Update Client') }}"
                    bgColor="bg-emerald-700" hoverColor="hover:bg-emerald-900"

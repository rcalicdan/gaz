    ...
    <div class="mb-4">
        <div class="bg-white rounded-lg shadow-sm border border-gray-200 p-3">
            <div class="flex flex-wrap items-center gap-3">
                ...
                <div class="relative">
                    <select wire:model.live="filterBrandCategory"
                        class="appearance-none pl-3 pr-8 py-1.5 text-sm border border-gray-300 rounded-md bg-white text-gray-900 focus:ring-2 focus:ring-indigo-500 focus:border-transparent transition-all duration-150 hover:border-gray-400 cursor-pointer min-w-[140px]">
                ...
                @php
                    $activeFiltersCount = collect([$filterProvince, $filterCity, $filterBrandCategory])
                        ->filter()
                        ->count();
                @endphp
            ...
            @if ($filterProvince || $filterCity || $filterBrandCategory)
                <div class="flex flex-wrap gap-1.5 mt-2.5 pt-2.5 border-t border-gray-100">
                    @if ($filterProvince)
                        <span
                            ...
                            {{ $filterProvince }}
                            <button wire:click="$set('filterProvince', '')" class="hover:text-emerald-900 ml-0.5">
                    ...
                    @if ($filterCity)
                        <span
                            ...
                            {{ $filterCity }}
                            <button wire:click="$set('filterCity', '')" class="hover:text-emerald-900 ml-0.5">
                                <svg class="w-3 h-3" fill="currentColor" viewBox="0 0 20 20">
                                    <path fill-rule="evenodd"
                                        d="M4.293 4.293a1 1 0 011.414 0L10 8.586l4.293-4.293a1 1 0 111.414 1.414L11.414 10l4.293 4.293a1 1 0 01-1.414 1.414L10 11.414l-4.293 4.293a1 1 0 01-1.414-1.414L8.586 10 4.293 5.707a1 1 0 010-1.414z"
                                        clip-rule="evenodd"></path>
                    ...
                    @if ($filterBrandCategory)
                        <span
                            ...
                            <span class="text-emerald-400">🏷️</span>
                            {{ $filterBrandCategory }}
                            <button wire:click="$set('filterBrandCategory', '')" class="hover:text-emerald-900 ml-0.5">
                                <svg class="w-3 h-3" fill="currentColor" viewBox="0 0 20 20">
                                    <path fill-rule="evenodd"
                                        d="M4.293 4.293a1 1 0 011.414 0L10 8.586l4.293-4.293a1 1 0 111.414 1.414L11.414 10l4.293 4.293a1 1 0 01-1.414 1.414L10 11.414l-4.293 4.293a1 1 0 01-1.414-1.414L8.586 10 4.293 5.707a1 1 0 010-1.414z"
                                        clip-rule="evenodd"></path>
